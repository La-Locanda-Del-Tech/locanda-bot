...
const cvGuide: string =
  "[galactic-CV-guide](https://github.com/GuidoPenta/galactic-CV-guide)";
const linkedInGuide: string =
  "[galactic-linkedin-profile-guide](https://github.com/GuidoPenta/galactic-linkedin-profile-guide)";
const reverseInterviewGuide: string =
  "[galactic-reverse-interview-guide](https://github.com/GuidoPenta/galactic-reverse-interview-guide)";
const awesomeItaliaRemote: string =
  "[awesome-italia-remote](https://github.com/GuidoPenta/awesome-italia-remote)";
const fullRemoteNewsletter: string =
  "[fullremote.it](https://github.com/GuidoPenta/fullremote.it)";
const remoteWorkExcel: string =
  "[PMI Italiane Lavoro Remoto](https://github.com/GuidoPenta/PMI-Italiane-Lavoro-Remoto)";
const jobSearchLinks: string =
  "[best-job-searches-website](https://github.com/GuidoPenta/best-job-searches-website)";
const salaryInfo: string =
  "[techcompenso.com](https://github.com/GuidoPenta/techcompenso.com)";
